...
/////////////
			...
			MultipleInputs.addInputPath(job2, new Path(args[0]), TextInputFormat.class, LocationCountMapper.class);
			MultipleInputs.addInputPath(job2, new Path(args[1]+"//First"), KeyValueTextInputFormat.class, LocationCountMapper1.class);
...
/////////////////
			...
			MultipleInputs.addInputPath(job3, new Path(args[0]), TextInputFormat.class, StationInvertingMapper.class);
			MultipleInputs.addInputPath(job3, new Path(args[1]+"//Second"), KeyValueTextInputFormat.class, StationInvertingMapper1.class);
