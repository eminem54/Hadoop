...
public class WordCount {
	...
	public static class MWordCountReducer extends
	Reducer<Text, LongWritable, Text, LongWritable> {
...
@Override
	...
	public static class MLocationCountReducer extends
	Reducer<Text, Text, Text, Text> {
static Map<String, Integer> m2 = new HashMap<String, Integer>();
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public static void main(String[] args) throws Exception {
		...
		MongoConfigUtil.setOutputURI( mconf, "mongodb://localhost/test.outFirst4" ); 
		Job mjob = Job.getInstance(mconf, "word count");
		mjob.setJarByClass(WordCount.class);
		mjob.setMapperClass(WordCountMapper.class);
		
		mjob.setReducerClass(MWordCountReducer.class);
		mjob.setOutputKeyClass(Text.class);
		mjob.setOutputValueClass(LongWritable.class);
		
		FileInputFormat.addInputPath(mjob, new Path(inputPath));
		mjob.setOutputFormatClass( MongoOutputFormat.class  ); 
		
		mjob.waitForCompletion(true);
/////////////
			...
			//mongodb 
			Configuration mconf2=new Configuration();
			MongoConfigUtil.setOutputURI( mconf2, "mongodb://localhost/test.outSecond4" ); 
			
			Job mjob2 = Job.getInstance(mconf2, "Location");
			
			mjob2.setJarByClass(WordCount.class);
			MultipleInputs.addInputPath(mjob2, new Path(inputPath), TextInputFormat.class, LocationCountMapper.class);
			MultipleInputs.addInputPath(mjob2, new Path(outputPath+"//First"), KeyValueTextInputFormat.class, LocationCountMapper1.class);

			mjob2.setReducerClass(MLocationCountReducer.class);
			mjob2.setNumReduceTasks(1);
			mjob2.setOutputKeyClass(Text.class);
			mjob2.setOutputValueClass(Text.class);
			mjob2.setOutputFormatClass( MongoOutputFormat.class  );
			
			
			mjob2.waitForCompletion(true);
			
			
/////////////////

			Configuration conf3=new Configuration();
			MongoConfigUtil.setOutputURI( conf3, "mongodb://localhost/test.outFinal4" ); 
